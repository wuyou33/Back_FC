...
// 		}
		...
		//if(!(baro_Offset == 0))
			...
			baro.height = (float)(s32)( pressure  )*10;//( my_deathzoom(( pressure - baro_Offset ), baroAlt ,baro_fix ) ) ; //cm + 
			...
			baro.relative_height = Moving_Median(mo_av_baro,MO_LEN ,&moavcnt,(s32)(pressure - baro_Offset))*10;
	///////////////////		
